"""
Django settings for instructor_42958 project.
...
ROOT_URLCONF = 'instructor_42958.urls'
...
WSGI_APPLICATION = 'instructor_42958.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "instructor_42958 API",
    "DESCRIPTION": "API documentation for instructor_42958 App",
    "VERSION": "v1",
}
